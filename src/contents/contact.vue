    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="row">
            <div class="col-lg-4">
              <input type="text" placeholder="Your Name" v-model="tenLienHe" />
            </div>
            <div class="col-lg-8">
          ...
          <div class="row">
            ...
            <v-btn @click="add()" color="red" class="col-lg-12"
...
input {
  background-image: linear-gradient(-45deg, bisque, darksalmon);
  border: 1px solid liner-gradient(-45deg, red, yellow);
  border-radius: 5px;
  width: 100%;
  font-family: 'Poppins', sans-serif;
}
